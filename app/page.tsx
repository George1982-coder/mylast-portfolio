...
export default function Home() {
  return (
    <MouseSpotlight>
      <main className="min-h-screen text-slate-100 font-sans" dir="rtl">
        ...
        <div className="max-w-4xl mx-auto mt-12 bg-slate-900/30 p-8 rounded-2xl border border-slate-800/50 backdrop-blur-sm">
          <p className="text-xl text-amber-100 leading-relaxed font-medium text-center">
            אני איש IT ומומחה תשתיות ורסטילי, המבצע מעבר לעולמות ה-Full Stack
            Web Development.
          </p>
          ...
          <p className="mt-4 text-slate-300 text-base leading-relaxed text-center max-w-2xl mx-auto">
            בתקופה האחרונה התרכזתי באינטנסיביות בפיתוח ווב מודרני, בניית
            פרויקטים מהעולם האמיתי ושליטה מלאה באקו-סיסטם של ה-Backend
            וה-Frontend.
          </p>
        ...
        <section className="py-16 px-6 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-blue-200 mb-2">
            הפרויקטים שלי
          </h2>
                ...
                <div className="overflow-hidden h-full text-right">
                  ...
                  <div className="p-4 md:p-5">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      המערכת כוללת מנגנון סינון וחיפוש חכם, ניהול מודעות דינמי
                      וממשק משתמש רספונסיבי ומותאם לנייד.
                    </p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="overflow-hidden h-full text-right">
                  ...
                  <div className="p-4 md:p-5">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      פלטפורמה דיגיטלית מודרנית להצגת פרויקטים ועיצובי עץ
                      מותאמים אישית
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="bg-slate-900/30 p-8 md:p-10 rounded-2xl border border-slate-800/50 backdrop-blur-sm">
            ...
            <p className="text-blue-100/70 mb-8">בואו נדבר — אשמח לשמוע מכם</p>

            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row flex-wrap justify-center items-stretch gap-4">
                <GlowCard className="min-w-55" variant="dark">
                  <a
                    href="https://wa.me/972524186300"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-slate-950/50 border border-slate-800 hover:border-blue-500/50 hover:bg-slate-900/80 transition-all duration-300 min-w-13.75 cursor-pointer h-full"
                  >
                    <FaPhone
                      className="text-xl text-blue-400 shrink-0"
                      aria-hidden
                    />
                    <TextDisperse
                      compact
                ...
                <GlowCard className="min-w-55" variant="dark">
                  <a
                    ...
                    className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-slate-950/50 border border-slate-800 hover:border-blue-500/50 hover:bg-slate-900/80 transition-all duration-300 min-w-55 cursor-pointer h-full"
                  >
                    <FaEnvelope
                      className="text-xl text-blue-400 shrink-0"
                      aria-hidden
              ...
              <div className="flex flex-row justify-center gap-4 w-full max-w-lg mx-auto">
                <GlowCard className="flex-1 min-w-0" variant="dark">
                  ...
                  >
                    <FaLinkedin
                      className="text-2xl text-[#0A66C2] shrink-0"
                      aria-hidden
                    />
